...
type Translation = {
  languageName: string
  landing: {
    tagline: string; button: string; trust: string; stepsLabel: string
    steps: [
...
export const translations: Record<LanguageCode, Translation> = {
  ko: {
    languageName: '한국어',
    landing: { tagline: '낯선 행정도, 하나씩 쉽게 안내해 드려요', button: '안내 시작하기', trust: '이름이나 외국인등록번호 없이 시작할 수 있어요.', stepsLabel: '이용 절차', steps: [
      { number: '01', title: '확인', description: '필요한 정보를 쉽게 확인' },
      { number: '02', title: '준비', description: '단계별로 차근차근 준비' },
      { number: '03', title: '연결', description: '필요한 도움을 빠르게 연결' },
    ] },
  ...
  en: {
    ...
    landing: { tagline: 'We guide you through unfamiliar procedures, one step at a time.', button: 'Start guidance', trust: 'You can start without your name or foreign registration number.', stepsLabel: 'How it works', steps: [
      { number: '01', title: 'Check', description: 'Easily check the information you need' },
      { number: '02', title: 'Prepare', description: 'Get ready step by step' },
      { number: '03', title: 'Connect', description: 'Quickly connect to the help you need' },
    ] },
  ...
  vi: {
    ...
    landing: { tagline: 'Chúng tôi hướng dẫn bạn từng bước qua các thủ tục xa lạ.', button: 'Bắt đầu hướng dẫn', trust: 'Bạn có thể bắt đầu mà không cần nhập tên hoặc số đăng ký người nước ngoài.', stepsLabel: 'Quy trình sử dụng', steps: [
      { number: '01', title: 'Xác nhận', description: 'Dễ dàng xác nhận thông tin cần thiết' },
      { number: '02', title: 'Chuẩn bị', description: 'Chuẩn bị từng bước rõ ràng' },
      { number: '03', title: 'Kết nối', description: 'Kết nối nhanh với sự hỗ trợ cần thiết' },
    ] },
  ...
  ne: {
    languageName: 'नेपाली',
    landing: { tagline: 'अपरिचित प्रशासनिक प्रक्रियामा पनि हामी एक-एक गर्दै सजिलै मार्गदर्शन गर्छौं।', button: 'मार्गदर्शन सुरु गर्नुहोस्', trust: 'नाम वा विदेशी दर्ता नम्बर नदिई सुरु गर्न सक्नुहुन्छ।', stepsLabel: 'प्रयोग प्रक्रिया', steps: [
      { number: '01', title: 'पुष्टि', description: 'आवश्यक जानकारी सजिलै पुष्टि गर्नुहोस्' },
      { number: '02', title: 'तयारी', description: 'चरणबद्ध रूपमा तयारी गर्नुहोस्' },
      { number: '03', title: 'जडान', description: 'आवश्यक सहयोगसँग छिटो जडान हुनुहोस्' },
    ] },
