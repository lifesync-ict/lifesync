...
const obligationFromApi = (item: ApiObligationItem, occurredAt: string | null): ObligationItem => {
  ...
  return {
    ...
    deadline: item.deadline ?? null, reviewDate: demoReviewDate(occurredAt), deadlineLabel: item.deadlineLabelKey, daysRemaining: item.daysRemaining ?? null, urgency: item.urgency,
